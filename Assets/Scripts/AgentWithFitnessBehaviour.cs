...
public class AgentWithFitnessBehaviour : MonoBehaviour {
	...
	Dictionary<Painting,float> paintingsFitness;
	...
	void initFitness(Painting[] list){
		paintingsFitness = new Dictionary<Painting, float>();
		foreach (Painting p in list) {
